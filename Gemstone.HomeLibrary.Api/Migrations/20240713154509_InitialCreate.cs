        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishDate = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    OpenLibraryKey = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    PersonalName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    OpenLibraryKey = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
